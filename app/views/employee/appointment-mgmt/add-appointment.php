            ...
            <section class="vet-main-content">
                ...
                <nav class="breadcrumbs-container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?= BASE_URL ?>/index.php?controller=employeeAppointment&action=index">Gestión de
                                Citas</a>
                        </li>
                ...
                <div class="admin-form-container">
                    <form id="formAgendarCita" class="p-3">
                        ...
                        <div id="datosClienteSeleccionado" class="border rounded p-3 mb-3" style="display:none;">
                            <h5 class="fw-bold mb-3"><i class="bi bi-person-check-fill"></i> Cliente Seleccionado</h5>

                            <div class="row">
                                <div class="form-item col-md-6 mb-2">
                                    <label class="form-label">Nombre</label>
                                    <input type="text" class="form-control" id="clienteNombreInput" disabled readonly>
                                </div>

                                <div class="form-item col-md-6 mb-2">
                                    <label class="form-label">Correo</label>
                                    <input type="text" class="form-control" id="clienteCorreoInput" disabled readonly>
                                </div>
                                ...
                                <div class="form-item col-md-6 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="clienteTelefonoInput" disabled readonly>
                                </div>
                        ...
                        <div id="contenedorMascotas" class="mb-3" style="display:none;">
                            <h5 class="fw-bold"><i class="bi bi-file-earmark-medical-fill"></i> Seleccione las mascotas
                            </h5>
