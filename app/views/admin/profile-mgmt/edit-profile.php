                ...
                <div>
                    ...
                    <nav class="breadcrumbs-container">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?= BASE_URL ?>/index.php?controller=adminProfile&action=index">Perfil de Usuario</a>
                            </li>
                    ...
                    <div class="contentProfile">
                        <form action="<?= BASE_URL ?>/index.php?controller=adminProfile&action=updateProfile" method="POST"
                            ...
                            <div class="editProfile">
                                ...
                                <div class="form-item">
                                    ...
                                    <input type="text" name="usuario_telefono"
                                        ...
                                        maxlength="8" pattern="\d{8}" inputmode="numeric" placeholder="Ej: 88888888"
                                        required>
                                </div>
                                ...
                                <div class="editProfile-footer">
                                    ...
                                    <a href="<?= BASE_URL ?>/index.php?controller=adminProfile&action=index"
