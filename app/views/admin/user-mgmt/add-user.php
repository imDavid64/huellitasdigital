        ...
        <section class="admin-main">
            ...
            <section class="admin-main-content-add-user">
                ...
                <div class="admin-form-container">
                    <form action="/huellitasdigital/app/controllers/admin/userController.php?action=store" method="POST"
                                ...
                                <select id="role" name="role" required>
                                    ...
                                    <?php foreach ($roles as $rol): ?>
                                        <option value="<?= $rol['ID_ROL_USUARIO_PK'] ?>">
                                            <?= $rol['DESCRIPCION_ROL_USUARIO'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <button type="submit" class="btn-blue"><strong>Agregar Usuario</strong><i
