            ...
            <section class="admin-main-content-add-user">
                ...
                <div class="admin-form-container">
                    <form id="editBrandForm" 
                          action="/huellitasdigital/app/controllers/admin/productController.php?action=updateBrand"
                          method="POST" enctype="multipart/form-data" novalidate>
                        <input type="hidden" name="id_brand" value="<?= $marca['ID_MARCA_PK'] ?>">
                        <input type="hidden" name="current_image_url" value="<?= htmlspecialchars($marca['MARCA_IMAGEN_URL']) ?>">

                        <div class="form-container">
                            <div class="form-item">
                                <label for="brandname">Nombre de la Marca</label>
                                <input type="text" id="brandname" name="brandname" value="<?= htmlspecialchars($marca['NOMBRE_MARCA']) ?>" required>
                            ...
                            <div class="form-item">
                                ...
                                <select id="state" name="state" required>
                                    ...
                                    <?php foreach ($estados as $estado): ?>
                                        <option value="<?= $estado['ID_ESTADO_PK'] ?>" <?= $marca['ID_ESTADO_FK'] == $estado['ID_ESTADO_PK'] ? 'selected' : '' ?>>
