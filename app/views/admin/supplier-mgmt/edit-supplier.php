        ...
        <section class="admin-main">
            ...
            <section class="admin-main-content-add-user">
                ...
                <div class="admin-form-container">
                    <form action="/huellitasdigital/app/controllers/admin/supplierController.php?action=update" method="POST">
                        ...
                        <div class="form-container">
                            ...
                            <div class="form-item">
                                ...
                                <input type="text" id="supplieraddress" name="supplieraddress"
                                    value="<?= htmlspecialchars($supplier['DIRECCION_SENNAS']) ?>">
                            </div>
                            <div class="form-item">
                                <label for="supplieremail">Correo electrónico</label>
                                <input type="email" id="supplieremail" name="supplieremail" value="<?= htmlspecialchars($supplier['PROVEEDOR_CORREO']) ?>"
                                    required>
                            </div>
                            <div class="form-item">
