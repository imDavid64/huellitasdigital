...
<footer>
    ...
    <div class="footer-content">
        <div>
            <div>
                <a href="/huellitasdigital/index.php" class="footer-logo">
        ...
        <div>
            <div class="footer-interest-links">
                ...
                <a href="pages/advices/faq.php">Preguntas Frecuentes</a>
                <a href="pages/aboutUs/misionVision.php">Nuestra Misión y Visión</a>
            </div>
