            ...
            <?php if (isset($_SESSION['user_name'])): ?>
                ...
                <div>
                    ...
                    <div class="header-user-menu" id="header-user-menu">
                        <ul>
                            <li><a href="/huellitasdigital/app/controllers/client/userController.php?action=index"><i
                            ...
                            <li><a href="pages/myAppointment.php"><i class="bi bi-calendar-event-fill"></i> Mis
                                    Citas</a></li>
                            <li><a href="/huellitasdigital/app/routes/web.php?action=logout"><i
                                        class="bi bi-door-open-fill"></i> Cerrar Sesión</a>
                            </li>
                        </ul>
                    </div>
                </div>
