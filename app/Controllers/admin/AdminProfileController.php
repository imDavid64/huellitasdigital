...
class AdminProfileController
{
    ...
    public function index()
    {
        ...
        require VIEW_PATH . "/admin/profile-mgmt/profile.php";
    }
    ...
    public function edit()
    {
        ...
        require VIEW_PATH . '/admin/profile-mgmt/edit-profile.php';
    }

    public function updateProfile(): void
    {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: ' . BASE_URL . '/index.php?controller=adminProfile&action=index');
            exit;
        }
