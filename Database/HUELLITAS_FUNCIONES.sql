...
RETURNS VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
DETERMINISTIC
BEGIN
    DECLARE salt_generado VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
CREATE FUNCTION HUELLITAS_ENCRIPTAR_CONTRASENNA_FN(
    P_CONTRASENNA_PLANA VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    P_SALT VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
RETURNS VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
DETERMINISTIC
BEGIN
    DECLARE V_CLAVE_ENCRIPTACION VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_CONTRASENNA_CON_SALT VARCHAR(355) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_CONTRASENNA_ENCRIPTADA VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
CREATE FUNCTION HUELLITAS_VERIFICAR_CONTRASENNA_FN(
    P_USUARIO_ID INT,
    P_CONTRASENNA_INTENTO VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
RETURNS BOOLEAN
DETERMINISTIC
READS SQL DATA
BEGIN
    DECLARE V_CONTRASENNA_ENCRIPTADA VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_SALT VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_CLAVE_ENCRIPTACION VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_CONTRASENNA_DESENCRIPTADA VARCHAR(355) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_CONTRASENNA_INTENTO_CON_SALT VARCHAR(355) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
RETURNS VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
DETERMINISTIC
BEGIN
...
CREATE FUNCTION HUELLITAS_ENCRIPTAR_DATO_FN(
    P_TEXTO_PLANO TEXT,
    P_NOMBRE_CLAVE VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
RETURNS TEXT
DETERMINISTIC
BEGIN
...
RETURNS VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
DETERMINISTIC
BEGIN
...
-- ==========================================
-- NOMBRE: GENERAR_CODIGO_PRODUCTO_FN
-- DESCRIPCIÓN: Función exclusivamente para generar códigos de SKU de productos
-- ==========================================
DROP FUNCTION IF EXISTS GENERAR_CODIGO_PRODUCTO_FN;
DELIMITER //
CREATE FUNCTION GENERAR_CODIGO_PRODUCTO_FN()
RETURNS VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
DETERMINISTIC
BEGIN
    DECLARE v_codigo VARCHAR(30);
    ...
    INSERT INTO huellitas_codigos_producto_tb (CODIGO_UNICO)
    VALUES ('TEMP');

    SET v_id = LAST_INSERT_ID();

    -- Formato: SKU-YYYYMMDD-0001
    SET v_codigo = CONCAT(
        'SKU-',
        DATE_FORMAT(NOW(), '%Y%m%d'),
        '-',
    ...
    -- Actualizar código real
    UPDATE huellitas_codigos_producto_tb
    SET CODIGO_UNICO = v_codigo
    WHERE ID_CODIGO_PK = v_id;
