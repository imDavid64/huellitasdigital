...
CREATE TABLE HUELLITAS_PEDIDOS_TB (
    ...
    CONSTRAINT HUELLITAS_PEDIDOS_USUARIO_FK FOREIGN KEY (ID_USUARIO_FK) REFERENCES HUELLITAS_USUARIOS_TB(ID_USUARIO_PK),
    CONSTRAINT HUELLITAS_PEDIDOS_ESTADO_FK FOREIGN KEY (ID_ESTADO_FK) REFERENCES HUELLITAS_ESTADO_TB(ID_ESTADO_PK)
);
...
CREATE TABLE HUELLITAS_PEDIDOS_DETALLE_TB (
    ...
    CONSTRAINT HUELLITAS_PEDIDOS_DETALLE_PEDIDO_FK FOREIGN KEY (ID_PEDIDO_FK) REFERENCES HUELLITAS_PEDIDOS_TB(ID_PEDIDO_PK),
    CONSTRAINT HUELLITAS_PEDIDOS_DETALLE_PRODUCTO_FK FOREIGN KEY (ID_PRODUCTO_FK) REFERENCES HUELLITAS_PRODUCTOS_TB(ID_PRODUCTO_PK)
);
...
CREATE TABLE HUELLITAS_PAGOS_TB (
    ...
    ID_PEDIDO_FK INT NOT NULL,
    ID_TRANSACCION_PROVEEDOR VARCHAR(255) NULL, -- ID que devuelve el procesador de pagos (Stripe, PayPal, etc.)
    ID_TARJETA_FK INT NULL, -- Si el pago fue con tarjeta guardada
    ...
    CONSTRAINT HUELLITAS_PAGOS_PEDIDO_FK FOREIGN KEY (ID_PEDIDO_FK) REFERENCES HUELLITAS_PEDIDOS_TB(ID_PEDIDO_PK),
    CONSTRAINT FK_PAGO_TARJETA FOREIGN KEY (ID_TARJETA_FK) REFERENCES HUELLITAS_TARJETAS_TB(ID_TARJETA_PK)
);
