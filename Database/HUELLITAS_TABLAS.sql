...
CREATE TABLE HUELLITAS_PRODUCTOS_TB (
    ...
    PRODUCTO_SKU VARCHAR(30) UNIQUE,
...
-- DESCRIPCIÓN: Tabla para almacenar imágenes del sliderbanner (Agregado por David)
-- ==========================================
...
CREATE TABLE HUELLITAS_NOTIFICACIONES_TB (
    ...
    ID_USUARIO_FK INT NOT NULL,
    ID_ESTADO_FK INT NOT NULL, -- Ej: 1=Activa, 2=Leída
    TITULO_NOTIFICACION VARCHAR(150) NOT NULL,
    MENSAJE_NOTIFICACION VARCHAR(1000) NOT NULL,
    TIPO_NOTIFICACION ENUM('INFORMACION', 'SISTEMA', 'PEDIDO', 'CITA', 'PROMOCION', 'OTRO') DEFAULT 'OTRO',
...
CREATE TABLE HUELLITAS_CODIGOS_PRODUCTO_TB (
    ID_CODIGO_PK INT NOT NULL AUTO_INCREMENT,
    CODIGO_UNICO VARCHAR(30),
