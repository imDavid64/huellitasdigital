...
CREATE PROCEDURE HUELLITAS_CAMBIAR_CONTRASENNA_SP(
    IN P_USUARIO_ID INT,
    IN P_CONTRASENNA_ACTUAL VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_CONTRASENNA_NUEVA VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_VALIDAR_LOGIN_SP(
    IN P_USUARIO_CORREO VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_CONTRASENNA_INTENTO VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_INICIALIZAR_CLAVE_ENCRIPTACION_SP(
    IN P_NOMBRE_CLAVE VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
-- ==========================================
-- NOMBRE: HUELLITAS_FILTRAR_PRODUCTOS_SP
-- DESCRIPCIÓN: Procedimiento filtrado dinamico de productos.
-- ==========================================
DROP PROCEDURE IF EXISTS HUELLITAS_FILTRAR_PRODUCTOS_SP;
DELIMITER $$
CREATE PROCEDURE HUELLITAS_FILTRAR_PRODUCTOS_SP(
    IN P_CATEGORIAS TEXT,   -- "1,2,3" o NULL
    IN P_MARCAS TEXT        -- "4,5"  o NULL
)
BEGIN
    SET @SQL = "
        SELECT 
    ...
    IF P_CATEGORIAS IS NOT NULL AND P_CATEGORIAS <> '' THEN
        SET @SQL = CONCAT(@SQL, " AND ID_CATEGORIA_FK IN (", P_CATEGORIAS, ") ");
    END IF;

    -- Filtro por marcas
    IF P_MARCAS IS NOT NULL AND P_MARCAS <> '' THEN
        SET @SQL = CONCAT(@SQL, " AND ID_MARCA_FK IN (", P_MARCAS, ") ");
    END IF;
...
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_PRODUCTO_SP (
    ...
    IN P_DESCRIPCION VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_SLIDER_BANNER_SP(
    ...
    IN P_IMAGEN_URL VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_DESCRIPCION_SLIDER_BANNER VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE PROCEDURE HUELLITAS_AGREGAR_SLIDER_BANNER_SP (
    IN p_imagen_url VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_descripcion VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_id_estado INT
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_AGREGAR_PROVEEDOR_SP(
    IN P_PROVEEDOR_NOMBRE VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_NOMBRE_REPRESENTANTE VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_PROVEEDOR_CORREO VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_ID_ESTADO_FK INT,
...
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_PROVEEDOR_SP(
    ...
    IN P_PROVEEDOR_CORREO VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_ID_ESTADO_FK INT,
    IN P_TELEFONO_CONTACTO VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_DIRECCION_SENNAS VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_CONTAR_PROVEEDORES_SP(
    IN p_query VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    SELECT 
        COUNT(*) AS TOTAL
...
CREATE PROCEDURE HUELLITAS_RECUPERAR_CONTRASENNA_SP (
    IN P_ID_USUARIO INT,
    IN P_NUEVA_CONTRASENNA VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    DECLARE V_EXISTE INT;
...
-- ==========================================
-- NOMBRE: HUELLITAS_REGISTRAR_USUARIO_SP
-- DESCRIPCIÓN: Procedimiento para registrar usuarios nuevos
-- ==========================================
DROP PROCEDURE IF EXISTS HUELLITAS_REGISTRAR_USUARIO_SP;
DELIMITER $$
CREATE PROCEDURE HUELLITAS_REGISTRAR_USUARIO_SP(
    ...
    IN P_CONTRASENNA VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
BEGIN
    ...
    -- Devolver el nuevo ID del usuario registrado
    SELECT LAST_INSERT_ID() AS NUEVO_ID_USUARIO;
END $$
DELIMITER ;
...
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_PERFIL_USUARIO_SP(
    ...
    IN P_USUARIO_NOMBRE VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_USUARIO_IDENTIFICACION INT,
    IN P_USUARIO_CUENTA_BANCARIA VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_USUARIO_IMAGEN_URL VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_ID_PROVINCIA_FK INT,
    IN P_ID_CANTON_FK INT,
    IN P_ID_DISTRITO_FK INT,
    IN P_DIRECCION_SENNAS VARCHAR(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_TELEFONO_CONTACTO INT
)
BEGIN
    DECLARE V_ID_DIRECCION INT;
...
CREATE PROCEDURE HUELLITAS_AGREGAR_CATEGORIA_SP (
    IN P_ID_ESTADO_FK INT,
    IN P_DESCRIPCION_CATEGORIA VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_AGREGAR_MARCA_SP (
    IN P_NOMBRE_MARCA VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_ID_ESTADO_FK INT,
    IN P_MARCA_IMAGEN_URL VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_LISTAR_PRODUCTOS_BUSCADOS_ACTIVOS_SP(
    IN P_BUSQUEDA VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    SELECT
        P.ID_PRODUCTO_PK,
    ...
    WHERE 
        ...
        AND (
            ...
            OR P.PRODUCTO_SKU LIKE CONCAT('%', P_BUSQUEDA, '%')
...
CREATE PROCEDURE HUELLITAS_BUSCAR_PRODUCTOS_ADMIN_SP(
    IN P_SEARCH_TERM VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_LIMIT_ROWS INT,
...
BEGIN
    ...
    WHERE 
        ...
        OR P.PRODUCTO_SKU LIKE CONCAT('%', P_SEARCH_TERM, '%')
        OR P.PRODUCTO_DESCRIPCION LIKE CONCAT('%', P_SEARCH_TERM, '%')
...
CREATE PROCEDURE HUELLITAS_BUSCAR_NOTIFICACIONES_ADMIN_SP(
    IN P_SEARCH_TERM VARCHAR(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_LIMIT_ROWS INT,
    IN P_OFFSET_ROWS INT
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_AGREGAR_COMENTARIO_SP(
    IN p_id_producto INT,
    IN p_id_usuario INT,
    IN p_comentario VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_calificacion VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_AGREGAR_TARJETA_SP (
    IN  P_ID_USUARIO INT,
    IN  P_TIPO_TARJETA VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,       -- 'CREDITO' | 'DEBITO'
    IN  P_MARCA_TARJETA VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,      -- 'VISA','MASTERCARD','AMEX','DINERS','OTHER'
    IN  P_NOMBRE_TITULAR VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN  P_NUMERO_TARJETA VARCHAR(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,     -- PLANO, TRIGGER CIFRA
    IN  P_FECHA_VENC_YM CHAR(7),          -- 'YYYY-MM'
    IN  P_CVV VARCHAR(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,                 -- PLANO, TRIGGER CIFRA
    IN  P_ES_PREDETERMINADO TINYINT(1),
    IN  P_IP VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE PROCEDURE HUELLITAS_AGREGAR_NOTIFICACION_SP(
    IN P_ID_USUARIO INT,
    IN P_TITULO VARCHAR(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_MENSAJE VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_TIPO VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_PRIORIDAD VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    -- VALIDAR QUE EL USUARIO EXISTA
    IF (SELECT COUNT(*) FROM huellitas_usuarios_tb WHERE ID_USUARIO_PK = P_ID_USUARIO) = 0 THEN
...
CREATE PROCEDURE HUELLITAS_NOTIFICACION_MASIVA_SP(
    ...
    IN P_MENSAJE VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_TIPO VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_PRIORIDAD VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_URL_REDIRECCION VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    INSERT INTO huellitas_notificaciones_tb (
        ID_USUARIO_FK,
...
CREATE PROCEDURE HUELLITAS_AGREGAR_SERVICIO_SP (
    IN P_ID_ESTADO_FK INT,
    IN P_NOMBRE_SERVICIO VARCHAR(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_DESCRIPCION_SERVICIO VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_IMAGEN_URL VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_CREAR_TOKEN_SP(
    ...
    IN p_ip VARCHAR(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_dispositivo VARCHAR(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    OUT p_token VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_VALIDAR_TOKEN_SP(
    IN p_token VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_tipo VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
-- ==========================================
-- NOMBRE: HUELLITAS_MARCAR_TOKEN_USADO_SP
-- DESCRIPCIÓN: Procedimiento almacenado para marcar un token como usado.
-- ==========================================
DROP PROCEDURE IF EXISTS HUELLITAS_MARCAR_TOKEN_USADO_SP;
DELIMITER $$
CREATE PROCEDURE HUELLITAS_MARCAR_TOKEN_USADO_SP(
    IN P_TOKEN_VALOR VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    UPDATE huellitas_tokens_tb
    SET USADO = TRUE
    WHERE TOKEN_VALOR = P_TOKEN_VALOR;
    
    -- Opcional: devolver cuántas filas fueron modificadas
    SELECT ROW_COUNT() AS FILAS_AFECTADAS;
END $$
DELIMITER ;

-- ==========================================
-- NOMBRE: HUELLITAS_CREAR_DIRECCION_SP
-- DESCRIPCIÓN: Procedimiento para crear direccion
-- ==========================================
DROP PROCEDURE IF EXISTS HUELLITAS_CREAR_DIRECCION_SP;
DELIMITER $$
CREATE PROCEDURE HUELLITAS_CREAR_DIRECCION_SP(
    IN P_PROVINCIA_ID INT,
    IN P_CANTON_ID INT,
    IN P_DISTRITO_ID INT,
    IN P_SENNAS VARCHAR(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    OUT P_ID_DIRECCION INT
)
BEGIN
    INSERT INTO huellitas_direccion_tb
    (
...
-- ==========================================
-- NOMBRE: HUELLITAS_CREAR_TELEFONO_SP
-- DESCRIPCIÓN: Permite crear telefonos
-- ==========================================
DROP PROCEDURE IF EXISTS HUELLITAS_CREAR_TELEFONO_SP;
DELIMITER $$
CREATE PROCEDURE HUELLITAS_CREAR_TELEFONO_SP(
    IN P_TELEFONO INT,
    OUT P_ID_TELEFONO INT
)
BEGIN
    INSERT INTO huellitas_telefono_contacto_tb 
    (
        ID_ESTADO_FK,
        TELEFONO_CONTACTO
    )
    ...
    SET P_ID_TELEFONO = LAST_INSERT_ID();
END $$
DELIMITER ;
...
-- ==========================================
-- NOMBRE: HUELLITAS_ACTIVAR_CUENTA_SP
-- DESCRIPCIÓN: Permite activar una cuenta de usuario
-- ==========================================
DROP PROCEDURE IF EXISTS HUELLITAS_ACTIVAR_CUENTA_SP;
DELIMITER $$
CREATE PROCEDURE HUELLITAS_ACTIVAR_CUENTA_SP(
    IN P_ID_USUARIO INT
)
BEGIN
    UPDATE huellitas_usuarios_tb
    SET 
        ID_ESTADO_FK = 1     -- 1 = Activo
    WHERE ID_USUARIO_PK = P_ID_USUARIO;
END $$
DELIMITER ;
...
CREATE PROCEDURE HUELLITAS_ADMIN_AGREGAR_USUARIO_SP(
    IN p_nombre VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_email VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE PROCEDURE HUELLITAS_ADMIN_ACTUALIZAR_USUARIO_SP(
    ...
    IN p_telefono VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_password VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_imagen VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    DECLARE v_id_telefono INT;
...
CREATE PROCEDURE HUELLITAS_AGREGAR_ROL_SP(
    IN p_descripcion VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_estado INT
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_PROCESAR_CHECKOUT_SP(
    IN p_usuario_id INT,
    IN p_envio_provincia VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_envio_canton VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_envio_distrito VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_envio_sennas VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_metodo_pago VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_tarjeta_id INT,
    IN p_costo_envio DECIMAL(10,2),
    OUT p_pedido_id INT,
    OUT p_codigo_pedido VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
-- ==========================================
-- NOMBRE: HUELLITAS_OBTENER_PAGO_POR_CODIGO_PEDIDO_SP
-- DESCRIPCIÓN: Procedimiento para obetener pago por codigo de pedido.
-- ==========================================
DROP PROCEDURE IF EXISTS HUELLITAS_OBTENER_PAGO_POR_CODIGO_PEDIDO_SP;
DELIMITER $$
CREATE PROCEDURE HUELLITAS_OBTENER_PAGO_POR_CODIGO_PEDIDO_SP(
    IN P_CODIGO_PEDIDO VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    SELECT 
        PG.*
    FROM huellitas_pagos_tb AS PG
    INNER JOIN huellitas_pedidos_tb AS P
...
-- ==========================================
-- NOMBRE: HUELLITAS_OBTENER_ESTADO_PAGO_SP
-- DESCRIPCIÓN: Procedimiento para obtener estado de pago por id de pedido.
-- ==========================================
DROP PROCEDURE IF EXISTS HUELLITAS_OBTENER_ESTADO_PAGO_SP;
DELIMITER $$
CREATE PROCEDURE HUELLITAS_OBTENER_ESTADO_PAGO_SP(
    IN P_ID_PEDIDO INT
)
BEGIN
    SELECT 
...
CREATE PROCEDURE HUELLITAS_SUBIR_COMPROBANTE_PAGO_SP(
    IN P_ID_PEDIDO INT,
    IN P_ID_USUARIO INT,
    IN P_URL_COMPROBANTE VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
    BEGIN
...
CREATE PROCEDURE HUELLITAS_SUBIR_NUEVO_COMPROBANTE_SP(
    IN p_codigo_pedido VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_usuario_id INT,
    IN p_url_comprobante VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_COMPROBANTE_PAGO_SP(
    ...
    IN p_observaciones    VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    OUT p_exito           INT,
    OUT p_mensaje         VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    DECLARE v_pedido_id          INT DEFAULT NULL;
...
DELIMITER $$
CREATE PROCEDURE HUELLITAS_OBTENER_DETALLE_PEDIDO_SP(
    IN p_codigo VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
    )
BEGIN
...
DELIMITER $$
CREATE PROCEDURE HUELLITAS_CONTAR_PEDIDOS_SP(
    IN P_SEARCH_TERM VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    SELECT COUNT(*) AS TOTAL
...
DELIMITER $$
CREATE PROCEDURE HUELLITAS_VER_DETALLE_PEDIDO_SP(
    IN P_CODIGO_PEDIDO VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_ESTADO_PEDIDO_SP(
    IN p_codigo_o_id VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_ESTADO_PAGO_SP(
    IN P_ID_PAGO INT,
    IN P_NUEVO_ESTADO VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    OUT P_MENSAJE VARCHAR(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    OUT P_ID_PEDIDO INT
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_VINCULAR_CLIENTE_USUARIO_SP(
    IN p_codigo_usuario VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
main_block: BEGIN
    DECLARE v_id_usuario INT;
    DECLARE v_correo VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
CREATE PROCEDURE HUELLITAS_AGREGAR_CLIENTE_SP(
    IN p_nombre VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_correo VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_identificacion VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_direccion_id INT,
    IN p_telefono_id INT,
    IN p_observaciones VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_estado_id INT,
    IN p_creado_por VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
proc:BEGIN
...
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_CLIENTE_SP(
    IN P_CODIGO_CLIENTE VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_NOMBRE VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_IDENTIFICACION VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE PROCEDURE HUELLITAS_OBTENER_DETALLE_CLIENTE_POR_CODIGO_SP(
    IN p_codigo VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_tipo VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
-- ==========================================
-- NOMBRE: HUELLITAS_ACTUALIZAR_MASCOTA_IMAGEN_SP
-- DESCRIPCIÓN: Procedimiento para actualizar la imagen de la mascota.
-- ==========================================
DROP PROCEDURE IF EXISTS HUELLITAS_ACTUALIZAR_MASCOTA_IMAGEN_SP;
DELIMITER $$
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_MASCOTA_IMAGEN_SP (
    IN P_CODIGO_MASCOTA VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_IMAGEN_URL VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    UPDATE huellitas_mascota_tb
...
CREATE PROCEDURE HUELLITAS_AGREGAR_MASCOTA_SP(
    ...
    IN p_genero VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_imagen_url VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_creado_por VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
...
CREATE PROCEDURE HUELLITAS_EDITAR_MASCOTA_SP(
    ...
    IN p_genero           VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_imagen_url       VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN p_modificado_por   VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    DECLARE v_id_mascota INT DEFAULT NULL;
    DECLARE v_id_usuario INT DEFAULT NULL;
...
CREATE PROCEDURE HUELLITAS_AGREGAR_HISTORIAL_MEDICO_SP(
    ...
    IN P_SONIDOS_PULMONARES VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_CONDICION_CORPORAL VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_REFLEJO_DEGLUTORIO VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_REFLEJO_TUSIGENO VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_LINFONODOS VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_PALPACION_ABDOMINAL VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_PIEL VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_MUCOSA VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_PULSO VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_ESTADO_MENTAL VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_LISTA_DIAGNOSTICO_PRESUNTIVO TEXT,
    IN P_LISTA_DEPURADA TEXT,
    IN P_EXAMENES TEXT,
    IN P_DIAGNOSTICO_FINAL TEXT,

    IN P_HISTORIAL_DIAGNOSTICO VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_HISTORIAL_TRATAMIENTO VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_HISTORIAL_NOTAS VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    -- ==========================================
...
CREATE PROCEDURE HUELLITAS_ACTUALIZAR_HISTORIAL_MEDICO_SP(
    IN P_CODIGO_HISTORIAL VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
    IN P_ID_ESTADO INT,
...
CREATE PROCEDURE HUELLITAS_AGENDAR_CITA_SP(
    ...
    IN P_MOTIVO VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
BEGIN
    ...
    DECLARE V_NOMBRE VARCHAR(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_CORREO VARCHAR(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_TELEFONO VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_IDENTIFICACION VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    DECLARE V_MASCOTA_MANUAL VARCHAR(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    
	DECLARE v_id_mascota INT DEFAULT NULL;
    DECLARE mascota_codigo VARCHAR(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
